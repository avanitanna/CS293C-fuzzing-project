...
logging.basicConfig(filename='jinja-fuzzer-cov-'+str(sys.argv[1])+'-'+str(sys.argv[2])+'-'+str(sys.argv[3])+'.log', 
...
plt.grid(True)
plt.savefig(strategy+"/jinja_cov/mutant_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+".png")
plt.clf()
...
plt.grid(True)
plt.savefig(strategy+"/jinja_cov/cov_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+".png")
plt.clf()
