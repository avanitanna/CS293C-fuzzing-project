...
for i in range(int(sys.argv[1])): #limit iterations of fuzzer
    ...
    for jinja_inp in inputs:
        ...
        for i,m in enumerate(mutant_srcs):   
            ...
            mutated_prog = m
            mutated_file = open(template_path,'w')
            ...
            if fuzzout[0] == "killed":
                ...
                with open('C:/Users/Avani/Data/Learning/UCSB_PREP/CS293C/CS293C-fuzzing-project/jinja-fuzzer/results/StmtReturnMutator/jinja_base_fuzzer/real_errors_50-50-50.txt','a') as realerror: 
                    realerror.write("jinja_inp\n")
                    realerror.write(jinja_inp)
                    realerror.write("\n")
                    realerror.write("mutant\n")
                    realerror.write(m)
                    realerror.write("\n")
...
## store logs
with open('C:/Users/Avani/Data/Learning/UCSB_PREP/CS293C/CS293C-fuzzing-project/jinja-fuzzer/results/StmtReturnMutator/jinja_base_fuzzer/output_log_50-50-50.txt','w') as data: 
...
plt.grid(True)
plt.savefig("C:/Users/Avani/Data/Learning/UCSB_PREP/CS293C/CS293C-fuzzing-project/jinja-fuzzer/results/StmtReturnMutator/jinja_base_fuzzer/mutant_50-50-50.png")
plt.clf()
...
plt.grid(True)
plt.savefig("C:/Users/Avani/Data/Learning/UCSB_PREP/CS293C/CS293C-fuzzing-project/jinja-fuzzer/results/StmtReturnMutator/jinja_base_fuzzer/cov_50-50-50.png")
plt.clf()
