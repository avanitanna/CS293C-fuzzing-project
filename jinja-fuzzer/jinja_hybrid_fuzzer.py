...
logging.basicConfig(filename='jinja-fuzzer-hybrid-'+str(sys.argv[1])+'-'+str(sys.argv[2])+'-'+str(sys.argv[3])+'.log', 
...
plt.title("Jinja Hybrid Guided Fuzzer")
...
plt.grid(True)
plt.savefig(strategy+"/jinja_hybrid/mutant_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+".png")
plt.clf()
...
plt.grid(True)
plt.savefig(strategy+"/jinja_hybrid/cov_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+".png")
plt.clf()
