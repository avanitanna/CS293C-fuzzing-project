...
plt.title("HTML Hybrid Guided Fuzzer")
...
plt.grid(True)
plt.savefig(strategy+"/html_hybrid/mutant_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+".png")
plt.clf()
...
plt.grid(True)
plt.savefig(strategy+"/html_hybrid/cov_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+".png")
plt.clf()
