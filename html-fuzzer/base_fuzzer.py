...
logging.basicConfig(filename='html-fuzzer-base-'+str(sys.argv[5])+'-'+str(sys.argv[1])+'-'+str(sys.argv[2])+'-'+str(sys.argv[3])+'.log', 
...
plt.grid(True)
plt.savefig(strategy+"/html_base/mutant_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+".png")
plt.clf()
...
plt.grid(True)
plt.savefig(strategy+"/html_base/cov_"+str(sys.argv[1])+"_"+str(sys.argv[2])+"_"+str(sys.argv[3])+".png")
plt.clf()
