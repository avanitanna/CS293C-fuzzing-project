...
## store logs
with open('C:/Users/Avani/Data/Learning/UCSB_PREP/CS293C/CS293C-fuzzing-project/html-fuzzer/results/StmtReturnMutator/html_base_fuzzer/output_log_50-50-50.txt','w') as data: 
...
plt.title("HTML Base Fuzzer")
plt.xlabel("Number of total iterations")
plt.ylabel("Mutants Remaining")
#plt.xticks(range(len(x_kill)+1))
plt.grid(True)
plt.savefig("C:/Users/Avani/Data/Learning/UCSB_PREP/CS293C/CS293C-fuzzing-project/html-fuzzer/results/StmtReturnMutator/html_base_fuzzer/mutant_50-50-50.png")
plt.clf()
...
plt.grid(True)
plt.savefig("C:/Users/Avani/Data/Learning/UCSB_PREP/CS293C/CS293C-fuzzing-project/html-fuzzer/results/StmtReturnMutator/html_base_fuzzer/cov_50-50-50.png")
plt.clf()
